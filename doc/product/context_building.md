...
| `skills_listing` | `format_skill_listing()`（`src/trilobite/skills.py`） | 可用 skills 清单（name/description/path），至少包含内置 `create-skill`，只读工具 `skill` 按名加载正文。详见 [skills.md](./skills.md) |
